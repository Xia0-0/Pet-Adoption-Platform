  ...
  const sendEmail = (e) => {
    ...
    return (
        <div className='section h-screen mt-20 lg:mb-20 mb-96 ' id='contact'>
            <div className='flex flex-col'><h1 className='text-4xl font-bold text-center  my-20 text-black'>联系我们</h1></div>
...
<img src={contact} className='w-96 header' alt="" data-aos="zoom-in-up" />
  ...
  <div className="p-6 ">
   <input type='submit' className='w-full bgg cursor-pointer text-white font-bold bg-[#D52B5C]  rounded-full py-3' value='发送'/>
    {/* <button
